...
import com.andlill.keynotes.ui.shared.dialog.BaseDialog
...
fun LabelDialog(state: MutableState<Boolean>, noteLabels: List<Label>, labels: List<Label>, onClick: (Label) -> Unit) {
    BaseDialog(
        state = state,
        title = stringResource(R.string.note_screen_dialog_labels_title),
        content = {
            LazyColumn(modifier = Modifier.heightIn(0.dp, 480.dp)) {
